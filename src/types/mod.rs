...
pub struct lean_object {
    ...
    pub _bitfield_1: Bitfield<[u8; 4usize]>,
}

impl lean_object {
    #[inline]
    pub fn m_cs_sz(&self) -> ::std::os::raw::c_uint {
        self._bitfield_1.get(0usize, 16u8) as _
    }
    #[inline]
    ...
    pub fn m_other(&self) -> ::std::os::raw::c_uint {
        self._bitfield_1.get(16usize, 8u8) as _
    }
    #[inline]
    pub fn set_m_other(&mut self, val: ::std::os::raw::c_uint) {
        self._bitfield_1.set(16usize, 8u8, val as u64) as _
    }
    #[inline]
    pub fn m_tag(&self) -> ::std::os::raw::c_uint {
        self._bitfield_1.get(24usize, 8u8) as _
    }
    #[inline]
    pub fn set_m_tag(&mut self, val: ::std::os::raw::c_uint) {
        self._bitfield_1.set(24usize, 8u8, val as u64) as _
    }
    #[inline]
    pub fn new_bitfield_1(
        ...
        let mut __bindgen_bitfield_unit: Bitfield<[u8; 4usize]> = Default::default();
        __bindgen_bitfield_unit.set(0usize, 16u8, m_cs_sz as u64);
        __bindgen_bitfield_unit.set(16usize, 8u8, m_other as u64);
        __bindgen_bitfield_unit.set(24usize, 8u8, m_tag as u64);
